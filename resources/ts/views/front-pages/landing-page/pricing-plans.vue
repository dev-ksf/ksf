...
let pricingPlans: Ref<PlanCategory[]> = ref([])
let selectedPlan: Ref<Plan[]> = ref([])
...
<template>
  <div 
    ...
    class="membership py-16"
  >
    <VContainer v-if="!selectedPlan.length">
      <div class="pricing-plans">
        <!-- 👉 Headers  -->
        <div class="headers d-flex justify-start flex-column align-left flex-wrap">
          <h4 class="d-flex align-start text-h4 mb-1 flex-wrap justify-start">
        ...
        <VRow>
          ...
          >
            <VCard
              ...
              :style="plan.is_recommended ? 'border:3px solid rgb(var(--v-theme-warning))' : ''"
              :class="plan.is_recommended ? 'recommended' : ''"
      ...
      <div class="pricing-plans">
        ...
        <div class="headers d-flex justify-start flex-column align-left flex-wrap">
          <h4 class="d-flex align-start text-h4 mb-12 flex-wrap justify-start">
            <div class="position-relative me-2">
              <div class="section-title cursor-pointer" @click="emptySelectedPlan()">
                <VIcon
        ...
        <VRow class="justify-center">
          <VCol
            v-for="(plan, index) in selectedPlan"
            :key="index"
            sm="6"
            md="6"
            lg="3"
